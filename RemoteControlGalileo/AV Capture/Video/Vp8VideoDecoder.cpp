...
bool Vp8VideoDecoder::setup()
{
    vpx_codec_iface_t *vpxInterface = vpx_codec_vp8_dx();
...
YuvBufferPtr Vp8VideoDecoder::decodeYUV(const void *buffer, size_t size)
{
...
void Vp8VideoDecoder::printCodecError(vpx_codec_ctx_t *context, const char *message)
{
