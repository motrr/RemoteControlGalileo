...
Vp9VideoEncoder::Vp9VideoEncoder()
{
}
...
bool Vp9VideoEncoder::setup(int width, int height, int bitratePerPixel, int keyframeInterval)
{
    ...
    vpx_codec_iface_t *vpxInterface = vpx_codec_vp9_cx();
...
BufferPtr Vp9VideoEncoder::encodeYUV(const void *buffer, size_t size, bool interleaved, bool &isKey)
{
...
const vpx_codec_cx_pkt_t *Vp9VideoEncoder::encodeImage(vpx_image_t *image)
{
...
void Vp9VideoEncoder::printCodecError(vpx_codec_ctx_t *context, const char *message)
{
